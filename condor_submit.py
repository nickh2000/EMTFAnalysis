...
for i in range(int(num_jobs)):
    ...
    #Run python script
    create += 'python3 ' + args.input + ' -n ' + args.num_jobs + ' -i ' + str(i) + ' \n'
    createName = '/afs/cern.ch/user/n/nhurley/EMTFAnalyzer/AWBTools/macros/plots/tmp/submit'+str(i)+'.sh' #Job's submission file output
